...
Public Class FM15_Origin
    ...
    Private Sub RefreshScreen()
        ...
        DataGridView1.DataSource = Show_Grid(DataGridView1, "tbm_origin")
    ...
    Private Sub btnDelete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnDelete.Click
        ...
        SQLstr = "DELETE from tbm_origin " & _
                 "where ori_code='" & TextBox1.Text & "'"
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If baru Then
            SQLstr = "Select * from tbm_origin where oricode='" & TextBox1.Text & "'"
            teks = "Save Data"
            ErrMsg = "Failed when saving user data"
            SQLstr = "INSERT INTO tbm_origin (ori_code,ori_name) " & _
                     "VALUES ('" & TextBox1.Text & "', '" & TextBox2.Text & "')"
        Else
            teks = "Update Data"
            ErrMsg = "Failed when updating user data"
            SQLstr = "UPDATE tbm_origin " & _
                     "SET ori_name = '" & TextBox2.Text & "'" & _
                     "where ori_code='" & TextBox1.Text & "'"
        End If
    ...
    Private Sub f_getdata()
        ...
        SQLstr = "select * from tbm_origin where ori_code = '" & TextBox1.Text & "' "
        ...
        If Not MyReader Is Nothing Then
            While MyReader.Read
                Try
                    teks = MyReader.GetString("ori_name")
