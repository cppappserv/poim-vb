''' <summary>
''' Title                         : Funds & Finance - Billing
''' SubForm                       : FrmBI
''' Table Used                    : 
''' Stored Procedure Used (MySQL) : SaveBI
''' 
''' 
''' </summary>
''' <remarks></remarks>
...
Public Class FrmBI
    ...
    Dim BINo, ShipNo, ShipOrdNo As Integer
    ...
    Sub New(ByVal No As Integer, ByVal Ship As Integer, ByVal ShipOrd As Integer, ByVal BLStat As String, ByVal BLNum As String)
        ...
        If Trim(BINo) <> 0 Then
            ...
            If (btnPrint.Enabled) And (PunyaAkses("BI-P")) Then
    ...
    Private Sub GetCostData()
        ...
        strSQL = "select cost_code,cost_description,cost_amount from tbl_Cost where shipment_no=" & ShipNo & " and ship_ord_no=" & ShipOrdNo & " and type_code = 'BI'"
    ...
    Private Sub DisplayData()
        ...
        Me.Text = "Billing #" & Trim(BINo) & " - Update"
        btnSave.Text = "Update"
        errMSg = "Billing data view failed"
        strSQL = "select * from tbl_shipping_doc where shipment_no=" & ShipNo & " and ord_no=" & BINo & " and findoc_type='BI'"
    ...
    Private Sub FrmBI_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Edit And BLStatus = "Closed" Then
            MsgBox("Billing has been closed, can't save data")
            Exit Sub
        End If
        ...
        If Baru Then
            SQLStr = "Run Stored Procedure SaveBI (Save" & "," & ShipNo & "," & "0"
        Else
            SQLStr = "Run Stored Procedure SaveBI (Update" & "," & ShipNo & "," & BINo
        End If
        ...
        If hasil = True Then
            f_msgbox_successful(btnSave.Text & " Billing")
            Me.Close()
            Me.Dispose()
        Else
            MsgBox(btnSave.Text & " Billing failed'")
        End If
    End Sub
    ...
    Private Sub btnReject_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReject.Click
        ...
        End If
        If Edit And BLStatus = "Closed" Then
            MsgBox("Billing has been closed, can't reject")
            Exit Sub
        End If
        msg = "Reject Billing #" & BINo & " of BL " & BLNo & Chr(13) & Chr(10) & "Are you sure ?"
        If MsgBox(msg, MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
            ...
            SQLstr = "UPDATE tbl_shipping_doc SET findoc_status='Rejected' " & _
                     "where shipment_no=" & ShipNo & " and ord_no=" & BINo & " and findoc_type='BI'"
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        PilihanDlg.SQLGrid = "Select tu.user_ct as UserCT,tu.user_id as UserID, tu.Name as UserName from tbm_users as tu inner join tbm_users_modul as tum on " & _
                             "tu.user_ct = tum.user_ct where tum.modul_code = 'BI-A'"
        PilihanDlg.SQLFilter = "Select tu.user_ct as UserCT,tu.user_id as UserID, tu.Name as UserName from tbm_users as tu inner join tbm_users_modul as tum on " & _
                               "tu.user_ct = tum.user_ct where tum.modul_code = 'BI-A'" & _
    ...
    Private Function GetTotal() As Decimal
        ...
        For cnt = 0 To brs
            ...
            If Not IsDBNull(temp) Then tot = tot + temp
        Next
        GetTotal = tot
    End Function
    ...
    Private Function GetRemark() As String
        ...
        For cnt = 0 To brs
            ...
            If temp <> "" Then rmk = rmk & ", " & AmbilData("costcat_name", "tbm_costcategory", "costcat_code=" & temp)
        Next
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        ...
        If Len(CStr(BINo)) = 1 Then
            v_num = " " & BINo
        Else
            v_num = BINo.ToString
        End If
        ViewerFrm.Tag = "Billing" & v_num & ShipNo
