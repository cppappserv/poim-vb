...
Public Class CRTandaTerimaPV
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "poim.CRTandaTerimaPV.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRTandaTerimaPV
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRTandaTerimaPV = New CRTandaTerimaPV
        rpt.Site = Me.Site
        Return rpt
    End Function
